    ...
    <>
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
          ...
          <Link href={'/doubleclick'} className="transition-all duration-300 bg-white dark:bg-[#36393F] hover:bg-blue-500 dark:hover:bg-blue-500 hover:shadow-xl m-2 p-4 relative z-40 group">
            <div className=" absolute bg-[#774FE9] top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  "></div>
            <div className="py-2 px-9 relative  ">
              <div className="flex items-center space-x-4">
